        ...
        <form class="mt-4" @submit.prevent="signIn">
          <label class="block">
            <input v-model="formData.email" type="email" placeholder="Email..."
              class="block w-full pl-2 mt-1 h-10 border-gray-200 rounded-md focus:border-indigo-600 focus:ring focus:ring-opacity-40 focus:ring-indigo-500">
          </label>
          ...
          <div class="flex items-center justify-between mt-4">
            ...
            <div>
              <router-link to="/requestJoin">
                <div class="block text-sm text-indigo-700 fontme hover:underline">creat new account?</div>
              </router-link>
            </div>
          </div>
