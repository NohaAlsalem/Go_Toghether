...
class usernotiScreen extends StatefulWidget {

  @override
  State<usernotiScreen> createState() => _usernotiScreenState();
}

class _usernotiScreenState extends State<usernotiScreen> {
