import 'dart:convert';
Temperatures finishdetailsFromJson(String str) => Temperatures.fromJson(json.decode(str));

String finishdetailsToJson(Temperatures data) => json.encode(data.toJson());
class Temperatures {
  int the0;
  Data data;
  String message;
