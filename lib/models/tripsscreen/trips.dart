...
import 'package:driverapp/models/tripsscreen/trips_search.dart';
...
class _tripsScreenState extends State<tripsScreen> {
  ...
  late List<Data> p = controller.productlist as List<Data>;
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
              ...
              onPressed: () {
                //    Get.to(Dataflightsearch());
                showSearch(context: context, delegate: Dataflightsearch());
              },
                  ...
                  itemBuilder: (c, index) {
                    return GestureDetector(
                      onTap: () {
                        ...
                        //print(id);
                        Get.to(DetailScreen()); //arguments: id);
                      },
                      child: Container(
                        child: Column(
                          children: [
...
height: 34,
                                ...
                                child: MaterialButton(
                                  ...
                                  onPressed: (){
                                    destoryresv(drivertoken.drivertokenn);
                                  },
                                  child: Text('destory',style: TextStyle(color:Colors.white,fontSize:12 ),),
                                  color: Colors.red,
                                ),
                              ),
                            ],
  ...
  Future<void> acceptresv(String token )async {

    var url=Uri.parse(serverconfig.domainserver+serverconfig.acceptresr+'${controller.productlist.id}');
    print(url);
    print(token);
  ...
  Future<void> destoryresv(String token )async {

    var url=Uri.parse(serverconfig.domainserver+serverconfig.destoryreservation+'${controller.productlist.id}');
    print(url);
    print(token);
          ...
          children: [
            ...
            SizedBox(
             ...
             SingleChildScrollView(
               ...
               ListView.builder(
                shrinkWrap: true,
                itemCount:3,//controller.productlist.reservations.length,
                itemBuilder: (c, index) {
                  return GestureDetector(
                    onTap: () {
                    //  id=controller.productlist.reservations[index].id;
                                        ...
                                        Row(
                                          children: [
                                           ...
                                           Padding(
                                             ...
                                             child: Text(
                                              'location:',//\n"${controller.productlist.reservations[index].location}",',//  controller.productlist.lastName,
                                              style: TextStyle(
                                                  fontSize: 14,
                                                  fontWeight: FontWeight.w600,
                                                  color: Colors.indigo),
