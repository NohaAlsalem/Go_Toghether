                ...
                children: [
                  Container(
                    ...
                    child: MaterialButton(
                      ...
                      child: Text('start',style: TextStyle(color:secondaryColor,fontSize:19),),
                      color: primaryColor,
                    ),
                  ),
                  SizedBox(width: 60,),
                  Container(
                    ...
                    child: MaterialButton(
                      ...
                      child: Text('end',style: TextStyle(color:secondaryColor,fontSize:18 ),),
                      color: primaryColor,
                    ),
                  ),
                ],
...
Padding(
  ...
  //var id=controller.productlist.id;
  Future<void> finishtrips(String token )async {

    var url=Uri.parse(serverconfig.domainserver+serverconfig.finishtrips+'${controller.productlist.id}');
    print(url);
    print(token);
  ...
  Future<void> starttrips(String token )async {

    var url=Uri.parse(serverconfig.domainserver+serverconfig.starttrips+'${controller.productlist.id}');
    print(url);
    print(token);
    var response = await http.get(
      url,
